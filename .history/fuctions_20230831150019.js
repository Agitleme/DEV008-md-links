...
export function linkFinder(stringArray) {
  ...
  stringArray.forEach((file) => {  //Itera a través de cada elemento
    const ArrayMatches = file.content.match(regex);//Almacena las coincidencias encontradas en el array 
    if (ArrayMatches) { 
