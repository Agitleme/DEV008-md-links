...
describe('isFiles', () => {
  ...
  it('deberia retornar true cuando es un archivo', async () => {
    expect(isFiles('C:\Users\apaom\OneDrive\Escritorio\MD Links\DEV008-md-links\README.md')).toBe(true)
  });
  it('deberia retornar false cuando es un directorio', async () => {
    expect(isFiles('C:\Users\apaom\OneDrive\Escritorio\MD Links\DEV008-md-links\testFile')).toBe(false)
  });
})
