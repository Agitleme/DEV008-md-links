...
function filterMarkdownFiles(arrayFile) {
  console.log (filterMarkdownFiles(arrayFile).filter(arrayFile => {
    const fileExtension = arrayFile.split('.').pop();
    console.log (fileExtension.toLowerCase() === 'md');
  }));
}
console.log(filterMarkdownFiles('./testFile')); // Salida: ['archivo1.md', 'archivo3.md']


/* Ejemplo de uso
const allFiles = ['archivo1.md', 'archivo2.txt', 'archivo3.md', 'archivo4.js'];
