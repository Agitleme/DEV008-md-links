...
export function routeValid(route) {
  ...
  } else { // Si el archivo o directorio no existe en la ruta dada
...
El objeto contiene el texto, el enlace, el nombre del archivo y el número de línea.*/
  ...
  if (links.length === 0) { //Después de procesar todas las líneas, se verifica si se encontraron enlaces (links.length === 0). 
