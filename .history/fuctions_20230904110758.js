...
export function statusLinks(arrayTheSameLinks) {
  ...
  //console.log(arrayTheSameLinks, "Estastus Links")
  return { total: arrayTheSameLinks.length, unique: setUniques.size }
}
statusLinks['https://github.com/Laboratoria/DEV008-md-links','https://github.com/Laboratoria/DEV008-md-links','https://github.com/Laboratoria/DEV008-md-links']