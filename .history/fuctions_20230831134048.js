...
export function isFile(route) { // Obtiene el estado (metadatos) del archivo o directorio en la ruta
  const stats = fs.statSync(route);
  if (stats.isFile()) {
    return true;// Devuelve el objeto de estado (metadatos) obtenido
  }
  else {
    return false
  }
